                ...
                def __init__ (self, skip_popup):
                    ...
                    if not skip_popup:
                        ...
                        if sys.platform.startswith ('darwin'): 
                            font = ("Courier New", 19)
                            b1 = tk.Button (popup, text = "Deletion", command = deletion, fg = "#008b8b")
                            b2 = tk.Button (popup, text = "Base Change", command = base_change, fg = "magenta")
                            b3 = tk.Button (popup, text = "Stop", command = stop, fg = "red")
                        else: 
                            font = ("Courier New", 13)
                            style_b1 = ttk.Style()
